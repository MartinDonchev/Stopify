namespace Stopify.Web.Areas.Identity.Pages.Account.Manage
{
...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(StopifyUser user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                this.urlEncoder.Encode("Stopify.Web"),
