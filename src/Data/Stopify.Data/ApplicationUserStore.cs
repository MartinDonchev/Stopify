namespace Stopify.Data
{
    ...
    {
        public ApplicationUserStore(StopifyDbContext context, IdentityErrorDescriber describer = null)
            : base(context, describer)
        {
        }

        protected override IdentityUserRole<string> CreateUserRole(StopifyUser user, ApplicationRole role)
        {
            return new IdentityUserRole<string> { RoleId = role.Id, UserId = user.Id };
        }

        protected override IdentityUserClaim<string> CreateUserClaim(StopifyUser user, Claim claim)
        {
        ...
        protected override IdentityUserLogin<string> CreateUserLogin(StopifyUser user, UserLoginInfo login) =>
